...
RUN           wget -O - http://downloads.sourceforge.net/project/davmail/davmail/4.4.1/davmail-linux-x86_64-4.4.1-2225.tgz | tar -C /usr/local/davmail --strip-components=1 -xvz
